...
\begin{enumerate}[label={[\arabic*]}, leftmargin=2em, itemsep=0.3em]
    ...
    \item Pazzani M J, Billsus D. Content-based recommendation systems[C]. The Adaptive Web. Springer, 2007: 325-341.
    ...
    \item Adomavicius G, Tuzhilin A. Context-aware recommender systems[C]. Recommender Systems Handbook. Springer, 2015: 191-226.
    ...
    \item 微信开放平台. 微信小程序开发文档[EB/OL]. https://developers.weixin.qq.com/miniprogram/dev/framework/, 2024.
    \item Ram{\'i}rez S. FastAPI[EB/OL]. https://fastapi.tiangolo.com/, 2024.
